...
public class SimpleUtterance implements Utterance {
	...
	private static Logger logger = Logger
			.getLogger("edu.cmu.sphinx.trainer.SimpleUtterance");
	 ...
	 */
	public void add(String transcript, Dictionary dictionary, boolean isExact,
			String wordSeparator) {
		logger.info("Transcript: " + transcript);
		transcriptSet.add(new SimpleTranscript(transcript, dictionary, isExact,
				wordSeparator));
	}
