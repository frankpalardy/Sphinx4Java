...
public class UtteranceHMMGraph extends Graph implements UtteranceGraph {
	 ...
	 */
	public UtteranceHMMGraph(Utterance utterance, AcousticModel acousticModel, UnitManager unitManager) {
		super();
		...
		for (utterance.startTranscriptIterator(); utterance
			...
			transcriptGraph = new TranscriptHMMGraph(transcript, acousticModel, unitManager);
			add(transcriptGraph);
		}
	}
