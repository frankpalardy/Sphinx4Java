...
/**
 * Defines the basic Node for any graph A generic graph Node must have a list of
 * outgoing edges and an identifier.
 */
public class Node {
	...
	/**
	 * The type of node, such as a dummy node or node represented by a specific
	 * type of symbol
	 */
	...
	/**
	 * Method to add an incoming edge. Note that we do not check if the
	 * destination node of the incoming edge is identical to this node
	 * 
	 * @param edge
	 *            the incoming edge
	 */
	...
	/**
	 * Method to add an outgoing edge. Note that we do not check if the source
	 * node of the outgoing edge is identical to this node
	 * 
	 * @param edge
	 *            the outgoing edge
	 */
	...
	/**
	 * Returns the ID of a node. Typically, a string representing a word or a
	 * phoneme.
	 * 
	...
	/**
	 * Validade node. Checks if all nodes have at least one incoming and one
	 * outgoing edge.
	 * 
	...
	public void print() {
		...
		for (startIncomingEdgeIterator(); hasMoreIncomingEdges();) {
			System.out.print(nextIncomingEdge() + " ");
		}
		System.out.print(" | ");
		for (startOutgoingEdgeIterator(); hasMoreOutgoingEdges();) {
