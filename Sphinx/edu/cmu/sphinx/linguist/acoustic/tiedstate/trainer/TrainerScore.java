...
public class TrainerScore {
	 ...
	 *            the score for the current frame
	 * @param state
	 *            the HMMState for this score object
	 * @param logAlpha
	 *            the forward probability
	 * @param logBeta
	 *            the backward probability
	 * @param logComponentProb
	 *            the mixture component a posteriori probabilities
	 */
	public TrainerScore(Data feature, float probability, HMMState state,
			float logAlpha, float logBeta, float[] logComponentProb) {
	 ...
	 */
	public TrainerScore(Data feature, float probability, HMMState state,
			float logAlpha, float[] logComponentProb) {
	 ...
	 * 
	 * @param likelihood
	 *            the log likelihood of the whole utterance
	 */
	 ...
	 * 
	 * @param logAlpha
	 *            the forward log probability
	 */
	public void setAlpha(float logAlpha) {
		this.logAlpha = logAlpha;
		//I added this in so the gamma is always up to date fp
		setGamma();
	}
	...
	/**
	 * Computes the a posteriori probability. This is the product of the current
	 * alpha and beta, or the summation of the current logAlpha and logBeta. The
	 * current beta is updated in the object, and the current alpha and beta are
	 * used.
	 */
