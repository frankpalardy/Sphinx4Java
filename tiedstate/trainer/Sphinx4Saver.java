 ...
 */
public class Sphinx4Saver extends Sphinx3Saver {

    /**
     * The logger for this class
     */
    private static Logger logger = 
	    Logger.getLogger(AcousticModel + "AcousticModel");
