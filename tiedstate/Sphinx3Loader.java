 ...
 * <p>
 * The acoustic model should be packaged in a JAR file. The dictionary and
 * language model files are not required to be in the package. You can specify
 * their locations separately. A text file called "model.props" and the data
 * files that make up the acoustic model are required. The model.props file is a
 * file of key-value pairs, loadable as a Java Properties file. It should
 * minimally contain the following properties:
 * <ul>
 * <li><b>dataLocation</b> - this specifies the directory where the actual
 * model data files are, <i>relative to the model implementation class</i></li>
...
public class Sphinx3Loader implements Loader {
	 ...
	 * The unit manager
	 */
	public final static String PROP_HMM_MANAGER = "hmmManager";

	/**
	 * Specifies whether the model to be loaded is in ASCII or binary format
	 */
	public final static String PROP_IS_BINARY = "binary";
	 ...
	 */
	public final static String PROP_MC_FLOOR = "MCFloor";
	 ...
	 */
	public final static String PROP_MW_FLOOR = "MWFloor";

	public final static float PROP_MW_FLOOR_DEFAULT = 1e-7f;
	
	public final static String PROP_TP_FLOOR = "TPFloor";

	public final static float PROP_TP_FLOOR_DEFAULT = 1e-7f;
	...
	private float transitionProbabilityFloor;
	...
	public void register(String name, Registry registry)
		...
		registry.register(PROP_HMM_MANAGER, PropertyType.COMPONENT);
	...
	public void newProperties(PropertySheet ps) throws PropertyException {
		...
		hmmManager = (HMMManager) ps.getComponent(PROP_HMM_MANAGER,
				HMMManager.class);
		...
		vectorLength = ps.getInt(PROP_VECTOR_LENGTH, PROP_VECTOR_LENGTH_DEFAULT);
		...
		transitionProbabilityFloor = ps.getFloat(PROP_TP_FLOOR, PROP_TP_FLOOR_DEFAULT);
